...
|---|-------------------|--------------|------------|
| 0a | Prérequis : Python + Jupyter | — | [Séance](./seminars/fr/00_prequisits.ipynb) |
| 0b | Prérequis : Git & GitHub | — | [Séance](./seminars/fr/00_prequisits_git.ipynb) |
| 1 | Session d'accueil & Premiers pas | [Diapositives ↗](./_static/slides/fr/01_environment_setup.html) | [Séance](./seminars/fr/01_python_basics.ipynb) |
...
| 8 | Tri et recherche | [Diapositives ↗](./_static/slides/fr/08_sorting_searching.html) | [Séance](./seminars/fr/08_sorting_searching.ipynb) |
...
Ce cours suit de près le manuel de la Runestone Academy intitulé ["Problem Solving with Algorithms and Data Structures using Python"](https://runestone.academy/ns/books/published/pythonds/index.html). Nous vous recommandons donc vivement de le lire. Voici d'autres ressources utiles :
